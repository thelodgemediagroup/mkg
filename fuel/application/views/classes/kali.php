		...
		<article class="article-container">
			<div class="container" >
				...
				<div class="row">
					...
					<figure>
						<img src="<?php echo img_path('mkg_images/class_kali/1.jpg'); ?>" alt="image">
					</figure>
					<figure>
						<img src="<?php echo img_path('mkg_images/class_kali/2.jpg'); ?>" alt="image">
					</figure>
					</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-8 col-md-offset-2">
								<img src="<?php echo img_path('mkg_images/class_kali/3.jpg'); ?>" alt="image">
							</div>
						</div>
					</div>
				</article>
